    ...
    const otvet={
      data(){
        return{
          ...
          y:'pod_vis',
          t:'<a href="index_stat_3.html"><button class="but_ex1"   v-if="show">К следующему заданию</button></a>'
    ...
    const answer ={
      data(){
        return{
          show:true,
          z:'<p>Решение.</p>',
          k:'<p>Страховая компания может либо заработать на такой сделке 300000 рублей с вероятностью 0,98, либо потерять 3000000 рублей с вероятностью 0,02. Составим закон распределения дискретной случайной величины Х – прибыль компании.</p><p><table border="1"><tr><td>X</td><td>+300000</td><td>-2700000</td></tr><tr><td>P</td><td>0,98</td><td>0,02</td></tr></table></p><p>Найдем математическое ожидание дискретной случайной величины.</p><p>M(X) = x<sub>1</sub> &#215 p<sub>1</sub> + x<sub>2</sub> &#215 p<sub>2</sub></p><p>M(X) = 300000 &#215 0,98 – 2700000 &#215 0,02 = 240000 рублей</p><p></p>'
        }
      }
    }
