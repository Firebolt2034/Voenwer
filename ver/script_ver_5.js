    ...
    const otvet={
      data(){
        return{
          ...
          y:'pod_vis',
          t:'<a href="index_ver_4.html"><button class="but_ex1"   v-if="show">К следующему заданию</button></a>'
    ...
    const answer ={
      data(){
        return{
          show:true,
          z:'<p>Решение.</p>',
          k:'<p>Обозначим через А. событие, состоящее в том, что один из 9 сбитых самолетов носитель. Общее число возможных случаев (из 30 самолетов сбито 9) будет равно n = C<sup>9</sup><sub>20</sub>, число случаев, благоприятных событию A, m = C<sup>9</sup><sub>20</sub> &#215 C<sup>2</sup><sub>4</sub></p> (из 4 носителей сбит 1, а из остальных 16 сбито 8). Следовательно, <img src="fromul_5.PNG">'
        }
      }
    }
