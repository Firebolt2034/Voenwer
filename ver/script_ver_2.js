    ...
    const otvet={
      data(){
        return{
          ...
          y:'pod_vis',
          t:'<a href="index_ver_3.html"><button class="but_ex1"   v-if="show">К следующему заданию</button></a>'
    ...
    const answer ={
      data(){
        return{
          show:true,
          z:'<p>Решение.</p>',
          k:'Пусть А - событие, состоящее в том, что взятый наугад патрон будет с осечкой. Всего возможных исходов n = 50, а исходов, благоприятствующих событию A, m = 4.<p><img src="formul_2.PNG"></p>'
        }
      }
    }
