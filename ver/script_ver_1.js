  ...
  const pod ={
    data(){
      return{
        ...
        x:'<h4>Статистическое определение вероятности</h4><p><span id="rule_of_sum">Относительной частотой</span>(частотой) события А называется отношение числа испытаний, в которых событие А наступило к общему числу произведенных испытаний.</p><p id="imp">W(A)=m:n</p><p id="center">где m - число испытаний, в которых событие А наступило, </p><p id="center">n - общее число произведенных испытаний.</p>'
      }
    }
  }
    ...
    const otvet={
      data(){
        return{
          ...
          y:'pod_vis',
          t:'<a href="index_ver_2.html"><button class="but_ex1"   v-if="show">К следующему заданию</button></a>'
